...
namespace Contoso.App_Start
{
    ...
    public static class NinjectWebCommon
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            //instance inject to interface. 
            kernel.Bind<IStudnetRepository>().To<StudentRepository>();
            ...
            //Services
            kernel.Bind<IStudentService>().To<StudentServices>();
            kernel.Bind<IPersonService>().To<PersonService>();
            kernel.Bind<IDepartmentService>().To<DepartmentServices>();
